...
$get_favorite_items = elgg_get_entities_from_relationship(array('relationship' => 'favorite', 'relationship_guid' => $_SESSION['user']->guid, 'inverse_relationship' => TRUE, 'types' => "object", 'subtypes' => $object_type, 'owner_guids' => 0, 'limit' => 99 ));
